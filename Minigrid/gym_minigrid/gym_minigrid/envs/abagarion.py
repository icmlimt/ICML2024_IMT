...
class Abagarion(PolicyRepairEnv):
    ...
    def __init__(self, size=17, agent_start_pos=(1, 1), agent_start_dir=0, **kwargs):
        super().__init__(
            size=size,
    ...
    def _gen_grid(self, width, height):
        ...
        x, y = self.PipeJunction.place(self.grid, 2, 2, orientation='L')
        self.PipeJunction.place(self.grid, x + 1, y)
        self.PipeCorridor.place(self.grid, x=2, y=8, width=3, height=4)
        self.PipeEnd.place(self.grid, x=10, y=10, width=3, height=3)
