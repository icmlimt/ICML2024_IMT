...
class SlipperyMini(PolicyRepairEnv):
    ...
    def _gen_grid(self, width, height):
        ...
        for i in range(3,6):
            self.put_obj(SlipperyNorth(), i, 2)
            self.put_obj(SlipperySouth(), i, 6)

        for j in range(3,6):
            self.put_obj(SlipperyWest(), 2, j)
            self.put_obj(SlipperyEast(), 6, j)
        ...
        self.put_obj(SlipperyNorth(), 2, 4)
        self.put_obj(SlipperyNorth(), 2, 5)
        self.put_obj(SlipperyNorth(), 1, 6)
        self.put_obj(SlipperyNorth(), 2, 6)
        '''
        # Place the agent
