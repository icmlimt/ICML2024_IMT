    ...
    namespace models {
        namespace sparse {
            ...
            public:
                ...
                /*!
                 * Removes given choices
                 *
                 * @param choices A bit vector that represents the set of choices that will get removed.
                 */
                void removeChoices(storage::BitVector const& choices);

                /*!
                 * Removes given choices
                 *
                 * @param labeling A bit vector that represents the set of choices that will get removed.
                 */
                void removeChoices(storage::BitVector&& choices);
