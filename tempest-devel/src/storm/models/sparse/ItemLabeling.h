        ...
        namespace sparse {
            ...
            protected:
               ...
               */
                ...
                /*!
                 * Used for model trimming. 
                 * Removes the given items
                 *
                 * @param items A bit vector that represents the items to be removed
                 */
                virtual void removeItems(storage::BitVector const& items);
                 ...
                 * @param items A bit vector that represents the items to be removed
                 */
                virtual void removeItems(storage::BitVector&& items);
