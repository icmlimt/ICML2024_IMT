        ...
        namespace sparse {
            ...
            struct ModelComponents {
                ...
                ModelComponents(storm::storage::SparseMatrix<ValueType> const& transitionMatrix,
                                ...
                                boost::optional<storm::models::sparse::ChoiceLabeling> const& choiceLabeling = boost::none,
                                boost::optional<std::shared_ptr<storm::storage::sparse::ChoiceOrigins>> const& choiceOrigins = boost::none)
                        : transitionMatrix(transitionMatrix), stateLabeling(stateLabeling), rewardModels(rewardModels), rateTransitions(rateTransitions), markovianStates(markovianStates), player1Matrix(player1Matrix), choiceLabeling(choiceLabeling), choiceOrigins(choiceOrigins) {
                ...
                ModelComponents(storm::storage::SparseMatrix<ValueType>&& transitionMatrix = storm::storage::SparseMatrix<ValueType>(),
                                ...
                                boost::optional<storm::models::sparse::ChoiceLabeling>&& choiceLabeling = boost::none,
                                boost::optional<std::shared_ptr<storm::storage::sparse::ChoiceOrigins>>&& choiceOrigins = boost::none)
                        : transitionMatrix(std::move(transitionMatrix)), stateLabeling(std::move(stateLabeling)), rewardModels(std::move(rewardModels)), rateTransitions(rateTransitions), markovianStates(std::move(markovianStates)), player1Matrix(std::move(player1Matrix)), choiceLabeling(choiceLabeling), choiceOrigins(choiceOrigins) {
                    // Intentionally left empty
                }
